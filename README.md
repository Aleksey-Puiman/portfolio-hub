# Алексей Пуйман
### Technical Content Specialist / AI-Creator
...
### 🤖 Vibe Coding & AI-Разработка
*Создание сложных веб-приложений и интерактивных элементов исключительно с помощью ИИ, выступая в роли архитектора и промпт-инженера.*

#### Проект "3D Interactive Globe"
> **Задача:** Разработка интерактивной 3D-модели Земли с динамической генерацией авиарейсов и сложной математикой (Three.js, TopoJSON) без ручного написания JavaScript-кода.

[![Посмотреть проект](https://img.shields.io/badge/LIVE_DEMO-ПОСМОТРЕТЬ_ПРОЕКТ-2ea44f?style=for-the-badge&logo=google-chrome&logoColor=white)](https://aleksey-puiman.github.io/3D-Interactive-Globe-Vibe-Coding-Case-/)

*   **Что сделано (Vibe Coding):**
    *   **AI-Архитектура:** 100% JS-логики приложения сгенерировано через нейросети с помощью детализированных, многоуровневых промптов.
    *   **Математика и физика:** Реализована генерация дуг полетов на основе весовой категории городов и алгоритм обхода запретных зон.
    *   **Ручной контроль:** Дебаггинг сгенерированного кода, финальная сборка модулей и ручная корректировка HTML/CSS-оболочки для корректного отображения в браузере.
